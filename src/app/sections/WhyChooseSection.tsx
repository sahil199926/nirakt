...
export function WhyChooseSection() {
  return (
    <section id="about" className="py-14 md:py-18 bg-sand">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5 mt-10 lg:mt-12">
          {WHY_CHOOSE_CARDS.map((card, index) => (
            <ScrollReveal key={card.title} delay={index * 0.06}>
              <div className="group bg-white rounded-2xl p-5 lg:p-6 border border-sand hover:border-primary/15 hover:shadow-card-hover transition-all duration-300 h-full">
                ...
                <h3 className="text-sm font-semibold text-primary mb-1.5">{card.title}</h3>
