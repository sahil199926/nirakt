...
export function FooterSection() {
  ...
  return (
    <footer className="relative bg-footer-bg pt-14 md:pt-16 pb-8 overflow-hidden">
      <div
        className="absolute inset-0 text-white pointer-events-none opacity-[0.04]"
        style={{
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-10 border-b border-white/10">
          ...
          <div className="lg:col-span-3">
            <Link href="/" className="inline-flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <span className="text-[9px] text-white/50 ml-1 uppercase tracking-wider">
                  Travels
                </span>
              </div>
            </Link>
            <p className="text-xs text-white/40 leading-relaxed mb-4">
              India&apos;s trusted travel companion for spiritual journeys,
              romantic getaways, and handcrafted adventures since 2018.
            </p>
          ...
          <div className="lg:col-span-2">
            <h4 className="text-[11px] font-semibold text-white/60 uppercase tracking-wider mb-4">
              Explore
            </h4>
        ...
        <div className="py-6 border-b border-white/10">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <p className="text-white/30 text-xs leading-relaxed max-w-md md:text-right">
              {BRAND.address}
            </p>
          </div>
        </div>
        ...
        <div className="pt-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-[11px] text-white/25 text-center sm:text-left">
            &copy; 2025 Nirakt Travels by Yantu Ventures Pvt. Ltd. All rights
            reserved.
          </p>
